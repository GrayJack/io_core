use crate::io::{self, ArrayBufWriter, IoSlice, Write};
...
#[derive(Debug)]
pub struct ArrayLineWriterShim<'a, W: ?Sized + Write, const N: usize> {
    buffer: &'a mut ArrayBufWriter<W, N>,
}
...
impl<'a, W: ?Sized + Write, const N: usize> Write for ArrayLineWriterShim<'a, W, N> {
