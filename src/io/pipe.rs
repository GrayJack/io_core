...
use crate::{
    io,
    sys::{pipe as imp, FromInner, IntoInner},
};
...
/// * [`PipeReader`] can be shared, and multiple processes or threads can read it at once. Any given
///   byte will only get consumed by one reader. There are no guarantees about data interleaving.
